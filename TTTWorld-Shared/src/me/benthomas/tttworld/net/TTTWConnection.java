...
public class TTTWConnection {
    ...
    public synchronized Packet receivePacket() throws IOException {
        ...
        while (this.packetBufferPos < this.packetBuffer.length && (l = this.input.read(this.packetBuffer, this.packetBufferPos, this.packetBuffer.length - this.packetBufferPos)) > 0) {
